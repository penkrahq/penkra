...
// Purpose: Locks down OpenCode text-generation behavior around server reuse,
...
const OpenCodeTextGenerationServerConfigLayer = ServerConfig.layerTest(process.cwd(), {
  prefix: "penkra-opencode-text-generation-test-",
});

const OpenCodeTextGenerationExistingServerConfigLayer = ServerConfig.layerTest(process.cwd(), {
  prefix: "penkra-opencode-text-generation-existing-server-test-",
});
